...
struct MuxyGameLink 			     { void *SDK; };
 // Any functions taking void* expect the actual struct pointer and not the Obj void* member, do not use .Obj anywhere
struct MGL_Error                       	     { const void *Obj; };
struct MGL_Payload                     	     { const void *Obj; };
struct MGL_Schema_User 	               	     { const void *Obj; };
struct MGL_Schema_AuthenticateResponse 	     { const void *Obj; };
struct MGL_Schema_DatastreamUpdate     	     { const void *Obj; };
struct MGL_Schema_DatastreamEvent      	     { const void *Obj; };
struct MGL_Schema_TwitchPurchaseBitsResponse { const void *Obj; };
...
MGL_RequestId     MuxyGameLink_AuthenticateWithRefreshToken(MuxyGameLink GameLink, const char* ClientId, const char* RefreshToken,
							void (*Callback)(void* UserData, MGL_Schema_AuthenticateResponse AuthResp),
							void* UserData);
...
// Do not store MGL_Schema_DatastreamEvent's or MGL_Schema_DatastreamUpdate's anywhere, they may be invalidated at the moment the callback finishes.
uint32_t      MuxyGameLink_OnDatastream(MuxyGameLink GameLink, void (*Callback)(void* UserData, MGL_Schema_DatastreamUpdate DatastreamUpdate), void* UserData);
...
uint32_t      MuxyGameLink_OnTwitchPurchaseBits(MuxyGameLink GameLink, void (*Callback)(void* UserData, MGL_Schema_TwitchPurchaseBitsResponse TPBResp), void* UserData);
